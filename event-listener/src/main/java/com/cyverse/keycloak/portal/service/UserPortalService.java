...
public class UserPortalService {
    ...
    private final Integer portalDivisor;
    ...
    public UserPortalService(ListenerHttpClient httpClient, String hmacKey, Integer portalDivisor) {
        this.httpClient = httpClient;
        this.hmacKey = hmacKey;
        this.portalDivisor = portalDivisor;
    }
    ...
    private boolean userExists(String username) {
        ...
        try {
            ...
            logger.error("Got exception trying to build API client body data: " + username + "\n" + jsonExc.getMessage());
        } catch (IOException | InterruptedException httpExc) {
            logger.error("Got exception from HTTP request to API client: " + httpExc.getMessage());
        }
    ...
    private Map<String, Object> buildUserPortalData(UserModel user) {
        ...
        data.put(String.valueOf(portalDivisor + 1), user.getFirstName());
        data.put(String.valueOf(portalDivisor + 2), user.getLastName());
    ...
    private byte[] getKey() throws Exception {
        ...
        digest.update(hmacKey.getBytes(StandardCharsets.UTF_8));
